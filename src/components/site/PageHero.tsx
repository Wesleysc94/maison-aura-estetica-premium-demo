...
export function PageHero({
  ...
  return (
    <section className="relative overflow-hidden px-6 pb-10 pt-32 sm:px-8 lg:px-12 lg:pb-12">
      ...
      <div className="mx-auto max-w-6xl rounded-[2rem] border border-border/50 bg-card/82 px-7 py-10 shadow-[0_30px_120px_-55px_rgba(90,70,58,0.32)] backdrop-blur md:px-12 md:py-12">
        <Reveal className="max-w-4xl space-y-5">
          ...
          <h1 className="max-w-[13ch] font-display text-5xl leading-[0.92] text-primary sm:text-6xl lg:text-[4.6rem]">
            {title}
          </h1>
          <p className="max-w-3xl text-base leading-8 text-primary/72 sm:text-lg">
            {description}
          </p>
          <Link
            to={ctaHref}
