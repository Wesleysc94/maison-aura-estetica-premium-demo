            ...
            <div className="relative z-10 w-full max-w-4xl text-cream flex flex-col items-center gap-4 mt-8 md:mt-16 mb-4 md:mb-0 text-center">
                ...
                <div className="hero-stagger mt-8 flex flex-col sm:flex-row gap-4 items-center justify-center w-full max-w-xl mx-auto">
                    <button
                        ...
                        className="group relative w-full sm:w-1/2 overflow-hidden bg-gradient-to-r from-accent/90 to-accent text-accent-foreground px-8 py-4 rounded-[2.5rem] font-sans-outfit text-base font-bold hover:scale-105 transition-transform duration-300 ease-in-out shadow-[0_0_20px_hsl(var(--accent)/0.5)] flex justify-center hover:shadow-[0_0_30px_hsl(var(--accent)/0.7)]"
                    >
                    ...
                    <button
                        ...
                        className="group relative w-full sm:w-1/2 overflow-hidden bg-gradient-to-r from-[#25D366]/90 to-[#25D366] text-white px-8 py-4 rounded-[2.5rem] font-sans-outfit text-base font-bold hover:scale-105 transition-transform duration-300 ease-in-out shadow-[0_0_20px_rgba(37,211,102,0.4)] flex justify-center hover:shadow-[0_0_30px_rgba(37,211,102,0.6)]"
                    >
